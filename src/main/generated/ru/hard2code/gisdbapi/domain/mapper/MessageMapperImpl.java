...
import ru.hard2code.gisdbapi.domain.entity.Message.MessageBuilder;
import ru.hard2code.gisdbapi.domain.entity.User;

@Generated(
    value = "org.mapstruct.ap.MappingProcessor",
    date = "2023-05-22T21:16:41+0300",
...
public class MessageMapperImpl implements MessageMapper {
    ...
    public Message toEntity(MessageDto messageDto) {
        ...
        message.question( messageDto.getQuestion() );
        message.answer( messageDto.getAnswer() );
        message.user( userMapper.toEntity( messageDto.getUser() ) );
