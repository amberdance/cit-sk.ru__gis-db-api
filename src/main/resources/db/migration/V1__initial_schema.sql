...
(
    ...
    CONSTRAINT pk_gis PRIMARY KEY (id)
);
...
ALTER TABLE information_systems
    ADD CONSTRAINT uc_gis_name UNIQUE (name);

ALTER TABLE organizations
    ADD CONSTRAINT uc_organizations_full_name UNIQUE (full_name);

ALTER TABLE organizations
    ADD CONSTRAINT uc_organizations_requisites UNIQUE (requisites);

ALTER TABLE organizations
    ADD CONSTRAINT uc_organizations_short_name UNIQUE (short_name);
